...
{-
NOTE: for tommorow:
What I have in this file ABOVE this point is probably correct. It finally lets
me have GExp, which can be weakened and partially unquoted, and
Sub which outputs GExps.
The question now is what type should unquote-n actually have here?
-}
